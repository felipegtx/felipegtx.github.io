    ...
    $(window).load(function () {
        ...
        function message() {
            ...
            [
                ...
                ["\uf044", 6, { x: 30, y: 350, strokeStyle: colors.white, alpha: 1, fontSize: "165px" }],
            ...
            .then(function partyDisk() {
                functionChain(writeText, [
                        ["\uf044", 6, { x: 30, y: 350, playMusic: false, strokeStyle: colors.green, alpha: 1, fontSize: "165px" }],
                        ["\uf044", 6, { x: 30, y: 350, playMusic: false, strokeStyle: colors.yellow, alpha: 1, fontSize: "165px" }],
                        ["\uf044", 6, { x: 30, y: 350, playMusic: false, strokeStyle: colors.red, alpha: 1, fontSize: "165px" }],
                        ["\uf044", 6, { x: 30, y: 350, playMusic: false, strokeStyle: colors.black, alpha: 1, fontSize: "165px" }],
                        ["\uf044", 6, { x: 30, y: 350, playMusic: false, strokeStyle: colors.blue, alpha: 1, fontSize: "165px" }]
                ]).then(function () {
